...
async function runStage1Tests() {
  ...
  console.log('Existing Projects in Registry:', JSON.stringify(initialProjects.data, null, 2));
...
NRL-INS-4001,Mount Differential Pressure Transmitter PDT-301,Instrumentation,12-CS-01,CDU Column Area,2026-09-11,2026-09-13`;
  ...
  console.log('New Project Activities List:', JSON.stringify(newProjectActivities.data.activities, null, 2));
  ...
  console.log(`First Activity Code in Demo: ${demoProjectActivities.data.activities[0]?.activity_code} (${demoProjectActivities.data.activities[0]?.description})`);
  console.log(`Last Activity Code in Demo: ${demoProjectActivities.data.activities[demoProjectActivities.data.activities.length - 1]?.activity_code} (${demoProjectActivities.data.activities[demoProjectActivities.data.activities.length - 1]?.description})`);
